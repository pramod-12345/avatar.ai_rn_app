...
import CreateStorySvg from "../../assets/svg/createStory.svg";
import CreateVoiceSvg from "../../assets/svg/createVoice.svg";
...
const Create = () => {
  const Avatars = [
    {
      ...
      description:
        "Give your avatar a personality, define how it should behave",
      svg: CreateAvatarSvg,
      navigateTo:''
  ...
  const renderAvatarItem = ({ item }: any) => {
    ...
    return (
      <TouchableOpacity style={styles.createContainer} onPress={() => navigationRef.navigate(item.navigateTo)}>
        <item.svg />
        {  item.id === 4 ? (
          <>
